/**
 * file: compiler.ts
 * description: ICU MessageFormat 编译器（vendor 自 @yyc3/i18n-core，MIT）
 ...
 *
 * brief: ICU MessageFormat 编译器（本地化内嵌）
 *
 * license: MIT
 */
