/**
 * file: engine.ts
 * description: i18n 核心引擎实现（vendor 自 @yyc3/i18n-core，MIT）
 * author: YanYuCloudCube Team
 * version: v2.3.0
 * created: 2026-04-24
 * updated: 2026-07-16
 * status: active
 * tags: [i18n],[engine],[vendor]
 *
 * brief: @yyc3/i18n-core 核心引擎（本地化内嵌，避免 file: 本地路径依赖）
 *
 * details:
 * - I18nEngine：含 LRU 缓存、locale 自动检测、localStorage 持久化、插件系统
 * - 支持 ICU MessageFormat（plural/select/selectOrdinal/number/date/time）
 * - 与 ./react/I18nProvider 配合使用
 *
 * license: MIT
 */
