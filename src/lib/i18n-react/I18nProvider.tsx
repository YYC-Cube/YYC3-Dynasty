 ...
 * description: React Context Provider（vendor 自 @yyc3/i18n-react，MIT）
 * author: YanYuCloudCube Team
 * version: v1.0.0
 * created: 2026-04-24
 * updated: 2026-07-16
 * status: active
 * tags: [i18n],[react],[vendor]
 *
 * brief: React Context Provider for i18n-core 引擎（本地化内嵌）
 *
 * license: MIT
 */
import { type I18nEngine, type Locale } from '../i18n-core';
